    ...
    <BannerLayout>
      <div className="absolute inset-0 z-20 flex flex-col items-center py-6 justify-center w-full h-full bg-gradient-to-t from-MidNightBlack">
        <div
          ...
          style={{ backgroundColor: "rgba(40, 5, 84, 0.1)" }}
        >
          <div className="flex items-center md:items-center md:justify-around">
            <div className="">
              <div className="">
                <h1 className="text-3xl sm:text-4xl xl:text-5xl text-Snow font-bold">
                  Pixels Gone Wild, Code Unleashed!
                </h1>
              </div>
              <div className="">
            ...
            <div className="w-48 h-52 relative hidden md:block">
              <img
                className="absolute top-8 w-full h-full object-cover rounded-tl-[100px] rounded-tr-[100px] rounded-bl-[0px] rounded-br-[0px] shadow-[0px_0px_50px_#030005]"
                src="images/sas.jpg"
                alt="emoji"
              />
            </div>
